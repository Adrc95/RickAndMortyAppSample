...
import com.adrc95.rickyandmorty.generated.resources.dimensions
import com.adrc95.rickyandmorty.generated.resources.icon_gender
import com.adrc95.rickyandmorty.generated.resources.icon_location
import com.adrc95.rickyandmorty.generated.resources.icon_world
import com.adrc95.rickyandmorty.generated.resources.last_seen
import com.adrc95.rickyandmorty.generated.resources.origin
import com.adrc95.rickyandmorty.generated.resources.residents
import com.adrc95.rickyandmorty.generated.resources.specie_gender
import com.adrc95.rickyandmorty.generated.resources.type
...
fun InfoGrid(
    ...
    Column(
        ...
        InfoCard(
            ...
            label = stringResource(Res.string.specie_gender),
            value = "${character.species} / ${character.gender}"
        )
        InfoCard(
            modifier = Modifier.fillMaxWidth(),
            icon = Res.drawable.icon_world,
        ...
        InfoCard(
            modifier = Modifier.fillMaxWidth(),
            icon = Res.drawable.icon_location,
            label = stringResource(Res.string.last_seen),
            moreInfo = true,
...
private fun MoreInfo(
    ...
    Column(
        ...
        MoreInfoItem(
            option = stringResource(Res.string.type),
            text = type ?: FALLBACK_TEXT,
            badge = false
        )
        MoreInfoItem(
            option = stringResource(Res.string.dimensions),
            text = dimension ?: FALLBACK_TEXT,
            badge = false
        )
        MoreInfoItem(
            option = stringResource(Res.string.residents),
