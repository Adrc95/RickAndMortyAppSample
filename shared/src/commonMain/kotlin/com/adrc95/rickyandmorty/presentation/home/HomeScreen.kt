...
import com.adrc95.rickyandmorty.generated.resources.empty_search_results
import com.adrc95.rickyandmorty.generated.resources.error_connectivity
import com.adrc95.rickyandmorty.generated.resources.error_load_characters
import com.adrc95.rickyandmorty.generated.resources.filter
import com.adrc95.rickyandmorty.generated.resources.icon_filter
import com.adrc95.rickyandmorty.generated.resources.search_by_name_placeholder
        ...
        topBar = {
            Column {
                ...
                Row(
                    ...
                    SearchBar(
                        placeholder = stringResource(Res.string.search_by_name_placeholder),
    ...
    PullToRefreshBox(
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            if (refresh is LoadState.Error) {
                ErrorBanner(
                    message = stringResource(Res.string.error_connectivity),
            ...
            if (appendState is LoadState.Error && characters.itemCount > 0) {
                ErrorBanner(
                    message = stringResource(Res.string.error_load_characters),
                    onRetry = { characters.retry() },
                    modifier = Modifier.align(Alignment.BottomCenter)
                )
            }
