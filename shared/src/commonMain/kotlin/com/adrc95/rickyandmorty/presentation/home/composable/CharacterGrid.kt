...
import com.adrc95.rickyandmorty.presentation.core.PresentationConstants.GRID_COLUMN_SIZE_COMPACT_DP
import com.adrc95.rickyandmorty.presentation.core.PresentationConstants.GRID_COLUMN_SIZE_EXPANDED_DP
import com.adrc95.rickyandmorty.presentation.core.PresentationConstants.GRID_COMPACT_WIDTH_THRESHOLD_DP
...
fun CharacterGrid(
    ...
    BoxWithConstraints(modifier = modifier.fillMaxSize()) {
        val minColumnSize = if (maxWidth < GRID_COMPACT_WIDTH_THRESHOLD_DP.dp) {
            GRID_COLUMN_SIZE_COMPACT_DP.dp
        } else {
            GRID_COLUMN_SIZE_EXPANDED_DP.dp
        }
