...
@Factory(binds = [SettingsRepository::class])
class SettingsRepositoryImpl(
    private val settingsDataSource: SettingsPreferenceDataSource
) : SettingsRepository {

    override fun getThemeMode(): Flow<ThemeMode> = settingsDataSource.themeMode.map {
        ThemeMode.from(it)
    }
