...
import com.adrc95.rickyandmorty.domain.builder.locationDetail as buildLocationDetail
...
class CharacterDisplayModelBuilder {
    ...
    var originDetail: LocationDetail? = buildLocationDetail()
    var location: SummaryLocation = summaryLocation()
    var locationDetail: LocationDetail? = buildLocationDetail()
