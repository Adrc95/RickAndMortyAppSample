...
class CharacterEntityMapperTest {
    ...
    @Test
    fun given_character_entity_when_mapped_to_domain_then_returns_character() {
        // Given
    ...
    @Test
    fun given_character_entity_with_null_origin_id_when_mapped_to_domain_then_returns_minus_one() {
        // Given
        val entity = characterEntity {
            withOriginId(null)
        }
    ...
    @Test
    fun given_character_entity_with_null_location_id_when_mapped_to_domain_then_returns_minus_one() {
        // Given
        val entity = characterEntity {
            withLocationId(null)
        }
    ...
    @Test
    fun given_character_entity_with_favourite_true_when_mapped_to_domain_then_preserves_favourite() {
        // Given
        val entity = characterEntity {
            withIsFavourite(true)
        }
